...
Works with your subscriptions on Claude Code, Codex, GitHub Copilot, Cursor, Grok Build, OpenCode, Pi, omp, fx, and Hermes Agent. If they’re installed and logged in, MonoCode-Copilot can run them. Tabs are sessions. The composer is the input. MonoCode-Copilot does not sell tokens.
